...
// Factory: Là 1 dạng Higher Order Function mà khi chúng ta gán vào 1 cái biến. Sau đó chúng ta dùng cái biến này để truy xuất vào cái data của cái
// closures đó (Lưu state khi closure được gán vào biến)
/////////////////////////////////////////////////////////////// Closures ///////////////////////////////////////////////////////////////
...
// Factory Function: Dựa trên Closure và Higher Order Function .Là 1 dạng Stateful function. Là 1 dạng function có khả năng truy cập vào cái data hay state của biến ở dạng outer (cái biến cha)
// và nhờ đó nó có thể tạo nên cái dạng factory function mà nó chứa các state của từng vùng hoạt động một.
// Dùng để xây dựng 1 hàm Factory (hàm nền tảng), từ đó xây dựng các hàm con với dữ liệu (data, state) riêng, tách biệt
// Không dùng "this" như Function Prototype. Không dùng newkeyword
