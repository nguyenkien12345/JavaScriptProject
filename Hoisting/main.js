...
// var age = 15; Chúng ta cần phân biệt kĩ 2 phần (var age) và (= 15). (var age) chính là phần khai báo biến. Còn (= 15) chính là phần gán giá trị cho biến. Áp dụng vào ví dụ trên thì nó sẽ chỉ đưa phần var age lên trên đầu nội dung chứ không đưa phần = 15 lên. Lúc này code sẽ như sau: 
// var age;
// console.log(age)                                        
// console.log(fullName)                                   
// age = 15;

// => Hoisting chỉ đưa phần khai báo biến lên trên đầu phạm vi chứ không hề đưa giá trị được gán vào biến lên trên đầu phạm vi
...
// => Hoisting đưa phần khai báo hàm lên trên đầu phạm vi
...
// + Lưu ý: Khai báo biến với let, const khi được hoisted không được tạo giá trị mặc định và được đưa vào "Temporal Dead Zone (Vùng tạm thời không sử dụng được)". Còn var khi hoisted lên sẽ được khởi tạo giá trị là undefined
